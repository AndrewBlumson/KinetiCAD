...
const SECTIONS = [
  ...
  },
  {
    ...
    paras: [
      ...
      "The simulation uses numerical integration and ideal joints, with its assumptions and limits stated alongside the engineering examples. An unchanged regression checks the windmill's 30 RPM drive against pi radians per second, within 0.0000005 rad/s after five simulated seconds. Ordinary assembly contact, bearing friction and finite motor torque are not modelled. Separate engineering experiments now let users explore motor loads, friction and contact, and beam stress and deflection, with their own tests and stated limits. That measured test establishes its stated case, not the accuracy or strength of every possible mechanism.",
    ],
  },
  {
